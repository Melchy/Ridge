...
internal class InitialHttpRequestMiddleware : HttpRequestFactoryMiddleware
{
    private readonly IActionDescriptorCollectionProvider _actionDescriptorCollectionProvider;

    public InitialHttpRequestMiddleware(
    ...
    {
        var actionInfo = ActionInfo.CreateActionInfo(requestFactoryContext.Arguments, requestFactoryContext.MethodInfo, requestFactoryContext.CustomParametersProvider);
        var actionDescriptor = GetActionDescriptor(requestFactoryContext.MethodInfo);
        ...
        actionInfo.RouteParams = GeneralHelpers.MergeDictionaries(routeDescription, actionInfo.RouteParams);
        actionInfo.HttpMethod = httpMethodAsString;

        requestFactoryContext.Body = actionInfo.Body;
        requestFactoryContext.RouteParams = actionInfo.RouteParams;
        requestFactoryContext.ContentType = actionInfo.BodyFormat;
        requestFactoryContext.Headers = actionInfo.Headers;
        requestFactoryContext.HttpMethod = actionInfo.HttpMethod;
    ...
    internal class ActionInfo
    {
            ...
            CustomParameterProvider customParametersProvider)
        {
            ...
            return new ActionInfo(body, routeParams, bodyFormat, headers, customParametersProvider);
        }
